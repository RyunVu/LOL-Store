...
public interface IProductRepository
{
    ...
    Task<bool> IsProductNameExistedAsync(string name, Guid? excludeProductId = null, CancellationToken cancellationToken = default);
    ...
    Task<Product?> SetProductCategoriesAsync(Product product, IEnumerable<Guid> categoryIds, CancellationToken cancellationToken = default);
    ...
    Task<bool> DeleteProductHistoriesAsync(IList<Guid> historyIds, CancellationToken cancellationToken = default); 
}
