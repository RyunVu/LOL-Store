...
export default function ProductsManagePage() {
  ...
  const { pageNumber, pageSize, categoryId, isActive, isDeleted, dateFilter, sortOrder } =
    filters
  ...
  }, [debouncedKeyword, pageNumber, pageSize, categoryId, isActive, isDeleted, dateFilter, sortOrder])
